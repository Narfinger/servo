...
pub enum WebDriverScriptCommand {
    ...
    DeleteCookies(GenericOneshotSender<Result<(), ErrorStatus>>),
    DeleteCookie(String, GenericOneshotSender<Result<(), ErrorStatus>>),
    ElementClear(String, GenericOneshotSender<Result<(), ErrorStatus>>),
    ExecuteScript(String, GenericOneshotSender<WebDriverJSResult>),
    ExecuteAsyncScript(String, GenericOneshotSender<WebDriverJSResult>),
    FindElementsCSSSelector(
        String,
        GenericOneshotSender<Result<Vec<String>, ErrorStatus>>,
    ),
    ...
    GetElementShadowRoot(
        String,
        GenericOneshotSender<Result<Option<String>, ErrorStatus>>,
    ),
    ElementClick(
        String,
        GenericOneshotSender<Result<Option<String>, ErrorStatus>>,
    ),
    GetKnownElement(String, GenericOneshotSender<Result<(), ErrorStatus>>),
    GetKnownShadowRoot(String, GenericOneshotSender<Result<(), ErrorStatus>>),
    GetKnownWindow(String, GenericOneshotSender<Result<(), ErrorStatus>>),
    GetActiveElement(GenericOneshotSender<Option<String>>),
    GetComputedRole(
        String,
        GenericOneshotSender<Result<Option<String>, ErrorStatus>>,
    ),
    GetCookie(
        String,
        GenericOneshotSender<Result<Vec<Serde<Cookie<'static>>>, ErrorStatus>>,
    ),
    GetCookies(GenericOneshotSender<Result<Vec<Serde<Cookie<'static>>>, ErrorStatus>>),
    GetElementAttribute(
        String,
        String,
        GenericOneshotSender<Result<Option<String>, ErrorStatus>>,
    ...
    GetElementProperty(
        String,
        String,
        GenericOneshotSender<Result<JSValue, ErrorStatus>>,
    ),
    GetElementCSS(
        String,
        String,
        GenericOneshotSender<Result<String, ErrorStatus>>,
    ),
    GetElementRect(
        String,
        GenericOneshotSender<Result<UntypedRect<f64>, ErrorStatus>>,
    ),
    GetElementTagName(String, GenericOneshotSender<Result<String, ErrorStatus>>),
    GetElementText(String, GenericOneshotSender<Result<String, ErrorStatus>>),
    GetElementInViewCenterPoint(
        String,
        GenericOneshotSender<Result<Option<(i64, i64)>, ErrorStatus>>,
    ),
    ScrollAndGetBoundingClientRect(
        String,
        GenericOneshotSender<Result<UntypedRect<f32>, ErrorStatus>>,
    ),
    GetBrowsingContextId(
        WebDriverFrameId,
        GenericOneshotSender<Result<BrowsingContextId, ErrorStatus>>,
    ),
    GetParentFrameId(GenericOneshotSender<Result<BrowsingContextId, ErrorStatus>>),
    GetUrl(GenericOneshotSender<String>),
    GetPageSource(GenericOneshotSender<Result<String, ErrorStatus>>),
    IsEnabled(String, GenericOneshotSender<Result<bool, ErrorStatus>>),
    IsSelected(String, GenericOneshotSender<Result<bool, ErrorStatus>>),
    GetTitle(GenericOneshotSender<String>),
    /// Deal with the case of input element for Element Send Keys, which does not send keys.
    WillSendKeys(
        String,
        String,
        bool,
        GenericOneshotSender<Result<bool, ErrorStatus>>,
    ),
