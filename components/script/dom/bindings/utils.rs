...
use crate::error::{Error, report_pending_exception, throw_dom_exception};
use crate::principals::PRINCIPALS_CALLBACKS;
use crate::proxyhandler::is_platform_object_same_origin;
